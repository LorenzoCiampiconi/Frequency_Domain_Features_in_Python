...
read_path = "C:/Users/Lorenzo/Documents/Polimi/Singapore/Sound and Music Computing/Assignment/#1/music_speech/"
output_path = "C:/Users/Lorenzo/Documents/Polimi/Singapore/Sound and Music Computing/Assignment/#1"
query_list_file_name = "music_speech.mf"
output_file_name = "#1outputB.arff"
sep = "\t"
range = 1024
hop = 512
...
header_lines = ["@RELATION music_speech","@ATTRIBUTE SC_MEAN NUMERIC","@ATTRIBUTE SRO_MEAN NUMERIC",
                ...
                "@ATTRIBUTE PARFFT_STD NUMERIC","@ATTRIBUTE FLUX_STD NUMERIC","@ATTRIBUTE class {music,speech}"]
...
def read_files(wav_list):
    ...
    with open(read_path + query_list_file_name, "r") as query_list_file:
        ...
        for line in query_list_file:
            ...
            samples = scipy.io.wavfile.read(read_path + wav_info.file_name)[1]
